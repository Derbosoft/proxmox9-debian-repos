#!/bin/bash
# ============================================================
# Script : proxmox-debian-repos.sh
# Auteur : Derbosoft
# Licence : MIT
# Description :
#   Ce script supprime les dépôts Proxmox Enterprise et configure
#   à la place les dépôts Debian Trixie + Proxmox no-subscription.
# ============================================================
